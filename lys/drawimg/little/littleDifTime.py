...
def draw(x, y, name, num):
    ...
    plt.grid(True)
    # plt.show()
    plt.savefig("E:\\datacollect\\picture\\little\\50sMovelittle\\" + str(name) + ".png")
    #plt.savefig("E:\\datacollect\\picture\\imge\\img" + str(count) + "_" + "3.jpg")
    plt.close(fig)


def main():
    t = "E:\\datacollect\\pre\\pre2068movelittle.txt"
    fwrit = open(t, "r")
