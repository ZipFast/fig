...
def draw(x, y, name, num):
    ...
    if p >= 0:
        ...
        plt.grid(True)
        # plt.show()
        plt.savefig("E:\\datacollect\\picture\\noMoving\\"+str(timeSeq)+"s\\" + str(name) + ".png")
        #plt.savefig("E:\\datacollect\\picture\\imge\\img" + str(count) + "_" + "1.jpg")
        plt.close(fig)


def main():
    t = "E:\\datacollect\\pre\\pre2068.txt"
    fwrit = open(t, "r")
