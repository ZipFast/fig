...
def draw(x, y, count, num):
    ...
    # plt.title('50秒采集坐标数(共：' + str(num) +"个点，去除相同点后，剩下："+str(n)+"个)")
    ...
    plt.grid(True)
    # plt.show()
    plt.savefig("E:\\datacollect\\picture\\unrealize\\60sunrealized\\" + str(count) + ".png")
    # plt.savefig("E:\\datacollect\\picture\\imge\\img" + str(count)+ "_" + "2.jpg")
    plt.close(fig)


def main():
    t = "E:\\datacollect\\pre\\pre2068unrealize.txt"
    fwrit = open(t, "r")
